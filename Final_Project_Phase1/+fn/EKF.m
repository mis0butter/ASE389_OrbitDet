...
if DATA == 1 
    [X_update, Y_prefit, L_pre, L_post, Y_postfit, P_update] = DATA_1(Yi, Xi, XSi, Ht_r_fn, Pi_bar, R); 
elseif DATA == 2
    [X_update, Y_prefit, L_pre, L_post, Y_postfit, P_update] = DATA_2(Yi, Xi, XSi, Ht_rr_fn, Pi_bar, R); 
else % DATA == 0 
    [X_update, Y_prefit, L_pre, L_post, Y_postfit, P_update] = DATA_0(Yi, Xi, XSi, Ht_fn, Pi_bar, R); 
end
...
function [Xstar, Y_prefit, L_pre, L_post, Y_postfit, P_update] = DATA_0(Yi, Xi, XSi, Ht_fn, Pi_bar, R)
    ...
    Hti_post = Ht_fn(Xstar(1), Xstar(2), Xstar(3), Xstar(4), Xstar(5), Xstar(6), XSi(1), XSi(2), XSi(3), XSi(4), XSi(5), XSi(6)); 
...
function [Xstar, Y_prefit, L_pre, L_post, Y_postfit, P_update] = DATA_2(Yi, Xi, XSi, Ht_rr_fn, Pi_bar, R)
    ...
    % POSTFIT Observation-state matrix 
    Hti_post = Ht_rr_fn(Xstar(1), Xstar(2), Xstar(3), Xstar(4), Xstar(5), Xstar(6), XSi(1), XSi(2), XSi(3), XSi(4), XSi(5), XSi(6)); 
